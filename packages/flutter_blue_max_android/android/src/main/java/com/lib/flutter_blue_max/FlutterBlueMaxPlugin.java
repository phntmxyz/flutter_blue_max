...
package com.lib.flutter_blue_max;
...
public class FlutterBlueMaxPlugin implements
    FlutterPlugin,
    MethodCallHandler,
    ...
    ActivityAware
{
    ...
    private static final String NAMESPACE = "flutter_blue_max";
...
class L2CapChannelManager {
    ...
    public synchronized void listenUsingL2capChannel(boolean secure, final Result resultCallback) {
        ...
        if (!adapter.isEnabled()) {
            plugin.log(FlutterBlueMaxPlugin.LogLevel.DEBUG, "Bluetooth is disabled. Please enable first.");
...
class L2CapServerChannel extends L2CapChannel {
    ...
    public synchronized void openStreams() throws IOException {
        plugin.log(FlutterBlueMaxPlugin.LogLevel.DEBUG, "Opening streams");
...
class MarshallingUtil {
    ...
    static HashMap<String, Object> bmBluetoothCharacteristic(BluetoothDevice device, BluetoothGattCharacteristic characteristic, BluetoothGatt gatt) {
        ...
        BluetoothGattService primaryService = FlutterBlueMaxPlugin.getPrimaryService(gatt, characteristic);
